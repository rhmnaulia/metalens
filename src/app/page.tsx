    ...
    <>
      ...
      {metadata && (
        <Tabs defaultValue='basic' className='animate-fade-in'>
          ...
          <TabsContent value='technical' className='space-y-4 animate-stagger'>
            <MetadataSection
              ...
              <MetadataGrid>
                  ...
                  <div className='flex items-center gap-2'>
                    <div
                      className={`w-2 h-2 rounded-full ${
                        metadata.sitemapExists ? 'bg-green-500' : 'bg-red-500'
                      }`}
                    />
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center gap-2'>
                    <div
                      className={`w-2 h-2 rounded-full ${
                        metadata.robotsTxtExists ? 'bg-green-500' : 'bg-red-500'
                      }`}
                    />
                    <p className='text-sm text-muted-foreground'>
